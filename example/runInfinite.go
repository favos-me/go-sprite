...
func main() {
	...
	explosion1.AddAnimation(sprite.DefaultAnimationLabel, "gfx/explosion1.png", explosionDuration, 5, ebiten.FilterDefault)
	explosion1.Position(10, windowHeight/3*2)
	explosion1.Start()

	explosion2 = sprite.NewSprite()
	explosion2.AddAnimation(sprite.DefaultAnimationLabel, "gfx/explosion2.png", explosionDuration, 7, ebiten.FilterDefault)
	explosion2.Position(windowWidth/2-24, windowHeight/3*2)
	explosion2.Start()

	explosion3 = sprite.NewSprite()
	explosion3.AddAnimation(sprite.DefaultAnimationLabel, "gfx/explosion3.png", explosionDuration, 9, ebiten.FilterDefault)
